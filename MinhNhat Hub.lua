...
OrionLib:MakeNotification({
    Name = "MinhNhat Hub",
    Content = "Made by MinhNhat. Thanks for use my script",
    Image = "rbxassetid://8192162908",
    Time = 10
})
...
OrionLib:MakeNotification({
        Name = "MinhNhat Hub"        Content = "Loading script complete!, You can now enable the function!",
        Image = "rbxassetid://8192162908",
        Time = 5
    })
